...
function foxtool_add_chat(){
	...
	if(isset($foxtool_options['chat-nav1']) && !is_page($pages_list)){
		...
		$nav0 = !empty($foxtool_options['chat-nav01']) ? '<a rel="nofollow" '. $nav0_link .'>'. $nav0_svg .'<span class="ft-navi-span">'. $nav0_tit .'</span></a>' : null;
		...
		$nav1 = !empty($foxtool_options['chat-nav11']) ? '<a '. $id_nav41 .' rel="nofollow" title="'. $foxtool_options['chat-nav21'] .'" href="'. $foxtool_options['chat-nav31'] .'">'. $foxtool_options['chat-nav11'] .'<span class="ft-navi-span">'. $foxtool_options['chat-nav21'] .'</span></a>' : null;
		...
		$nav2 = !empty($foxtool_options['chat-nav12']) ? '<a '. $id_nav42 .' rel="nofollow" title="'. $foxtool_options['chat-nav22'] .'" href="'. $foxtool_options['chat-nav32'] .'">'. $foxtool_options['chat-nav12'] .'<span class="ft-navi-span">'. $foxtool_options['chat-nav22'] .'</span></a>' : null; 
		...
		$nav3 = !empty($foxtool_options['chat-nav13']) ? '<a '. $id_nav43 .' rel="nofollow" title="'. $foxtool_options['chat-nav23'] .'" href="'. $foxtool_options['chat-nav33'] .'">'. $foxtool_options['chat-nav13'] .'<span class="ft-navi-span">'. $foxtool_options['chat-nav23'] .'</span></a>' : null; 
		...
		$nav4 = !empty($foxtool_options['chat-nav14']) ? '<a '. $id_nav44 .' rel="nofollow" title="'. $foxtool_options['chat-nav24'] .'" href="'. $foxtool_options['chat-nav34'] .'">'. $foxtool_options['chat-nav14'] .'<span class="ft-navi-span">'. $foxtool_options['chat-nav24'] .'</span></a>' : null;
	...
	$navi31 = !empty($foxtool_options['chat-nav-c31']) ? '--bordcolorspan:'. $foxtool_options['chat-nav-c31'] .';' : NULL;
	...
	$navi = ($navi1 || $navi2 || $navi3 || $navi31 || $navi4 || $navi5 || $navi6) ? ':root{'. $navi1 . $navi2 . $navi3 . $navi31 . $navi4 . $navi5 . $navi6 .'}' : NULL; 
